...
type PaymentServiceClient interface {
	...
	ListPayments(ctx context.Context, in *ListPaymentRequests, opts ...grpc.CallOption) (*ListPaymentResponse, error)
}
...
func (c *paymentServiceClient) ListPayments(ctx context.Context, in *ListPaymentRequests, opts ...grpc.CallOption) (*ListPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	...
	ListPayments(context.Context, *ListPaymentRequests) (*ListPaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) ListPayments(context.Context, *ListPaymentRequests) (*ListPaymentResponse, error) {
...
func _PaymentService_ListPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ListPayments(ctx, req.(*ListPaymentRequests))
	}
	return interceptor(ctx, in, info, handler)
}
